...
public class AssertJTest {
    ...
    public void testDate() {
        ...
        assertThat(DateUtil.parse("2018-05-15"))
                .isEqualTo("2018-05-15")
                .isAfter("2018-04-01")
                .isNotEqualTo("2018-05-14")
                .isBefore("2029-03-01");
        // 断言 2018 在指定年份之前 在指定年份之后
        assertThat(DateUtil.now()).isBeforeYear(2030).isAfterYear(2017);
        // 断言时间再指定范围内 不在指定范围内
        assertThat(DateUtil.parse("2018-05-15"))
        ...
        Date date1 = DateUtil.parseDatetimeWithMs("2018-01-01T01:00:00.000");
        Date date2 = DateUtil.parseDatetimeWithMs("2018-01-01T01:00:00.555");
        Date date3 = DateUtil.parseDatetimeWithMs("2018-01-01T01:00:55.555");
        Date date4 = DateUtil.parseDatetimeWithMs("2018-01-01T01:55:55.555");
        Date date5 = DateUtil.parseDatetimeWithMs("2018-01-01T05:55:55.555");
