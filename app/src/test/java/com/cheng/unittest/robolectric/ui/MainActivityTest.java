package com.cheng.unittest.robolectric.ui;
...
import com.cheng.unittest.ui.fragment.SampleFragment;
...
public class MainActivityTest {
    ...
    public void testJump() {
        ...
        // 校验Intent的正确性
        assertEquals(nextIntent.getComponent().getClassName(), LoginMVPActivity.class.getName());
    }
...
//        assertEquals(Toast.LENGTH_LONG.toLong(), shadowToast)
